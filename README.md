...
### Desenvolvedor Java Pleno | Back-end Java | Spring Boot | Metodologias Ágeis

> Desenvolvedor Java Pleno apaixonado por construir o alicerce de sistemas robustos. Transformo desafios de back-end em soluções eficientes e escaláveis com Java, Spring Boot e práticas Ágeis.
...
![Struts](https://img.shields.io/badge/Struts-0000FF?style=for-the-badge&logo=apache&logoColor=white)
...
![REST](https://img.shields.io/badge/REST-000000?style=for-the-badge&logo=databricks&logoColor=white)
![SoapUI](https://img.shields.io/badge/SoapUI-5E854A?style=for-the-badge&logo=soapui&logoColor=white)

---

## 🚀 Minha Jornada Profissional

**MJV Technology & Innovation** (Desde dez de 2021)

-   **Desenvolvedor Java Pleno** (jul de 2023 - o momento)
    -   Desenvolvimento de aplicações back-end com Java 8 e Spring Boot.
    -   Criação e manutenção de APIs RESTful.
    -   Implementação de soluções seguindo a metodologia Ágil Scrum.

-   **Analista de Sistema** (abr de 2022 - jul de 2023)
    -   Atuação no desenvolvimento do Portal Aceite na ODONTOPREV.
    -   Implementações full stack com Java, Spring Boot, JavaScript e Angular.

-   **Desenvolvedor Java Júnior** (dez de 2021 - ago de 2022)
    -   Correção de bugs e implementação de melhorias em sistemas legados.
    -   Sustentação de sistemas e auxílio à equipe de desenvolvimento.
...
-   **Desenvolvedor Fullstack Web**
    -   Escola SENAI "José Ephim Mindlin" (2020 - 2022)
